# Contributing to guide-to-staying-productive

First and foremost, thank you! We appreciate that you want to contribute to guide-to-staying-productive, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for guide-to-staying-productive**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for guide-to-staying-productive:

- star the [project](https://github.com/jonschlinkert/guide-to-staying-productive)
- tweet your support for guide-to-staying-productive
...
- **version**: please note the version of guide-to-staying-productive are you using
